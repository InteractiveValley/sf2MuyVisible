 ...
 * @ORM\Entity(repositoryClass="InteractiveValley\BackendBundle\Repository\ConfiguracionesRepository")
...
class Configuraciones
{
    ...
    */
    ...
    {
        $this->slug = \InteractiveValley\BackendBundle\Utils\Richsys::slugify($this->getConfiguracion());
    }
    ...
    */
    public function preSaveLinkVideo()
    {
      if ($this->getTipoConfiguracion()==self::$LINK_VIDEO) {
        $infoVideo=  \InteractiveValley\BackendBundle\Utils\Richsys::getTitleAndImageVideoYoutube($this->getTexto());
